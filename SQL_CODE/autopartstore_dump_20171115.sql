...
--
-- Host: localhost:3306
-- Generation Time: Nov 15, 2017 at 10:19 PM
...
INSERT INTO `part` (`PartNo`, `Pname`, `PCompany`, `PImage`, `Price`, `SubCatID`, `WarrantyID`) VALUES
('01320', 'Max ATF', 'Royal Purple', '01320.jpg', 7.99, 'Transmission Fluid', 7),
('04159', 'Battery Cable', 'Lynx O.E', '04159.jpg', 23.99, 'Battery Cable', 1),
('06822', 'Transmax DEXRON-VI', 'Castrol', '06822.jpg', 8.39, 'Transmission Fluid', 7),
('10418', 'Multi-Vechile Automatic Transmission Fluid', 'Lucas', '10418.jpg', 7.99, 'Transmission Fluid', 7),
('242-5530', 'Battery Cable', 'Dorman', '242-5530.jpg', 118.99, 'Battery Cable', 1),
('24454', 'Personal Battery Charger', 'OEM', '24454.jpg', 89.99, 'Battery Booster', 1),
('258-504', 'Air Filter Box', 'Droman', '258-504.jpg', 165.99, 'Air Filter Box', 4),
('258-521', 'Air Filter Box', 'Droman', '258-521.jpg', 142.99, 'Air Filter Box', 4),
('258-522', 'Air Filter Box', 'Droman', '258-522.jpg', 259.99, 'Air Filter Box', 4),
('25886', 'Coiled Cord Circuit Tester', 'OEM', '25886.jpg', 9.99, 'Circuit Tester', 1),
('3397001394', 'Wiper Blade', 'Bosch', '3397001394.jpg', 64.99, 'Wiper Blade', 3),
('42754', 'Wiper Arm', 'Droman', '42754.jpg', 29.99, 'Wiper Arm', 1),
('550022779', 'Mortor Oil', 'Pennzoil', '550022779.jpg', 6.29, 'Engine Oil', 7),
('550045127', 'Rotella T Triple', 'Shell', '550045127.jpg', 43.99, 'Engine Oil', 7),
('65-AGM', 'Platinum Battery', 'Duralast', '65-agm.jpg', 183.99, 'Battery', 3),
('74-209', 'Wiper Arm', 'Trico HD', '74-209.jpg', 79.99, 'Wiper Arm', 6),
('78S-DL', 'Battery', 'Duralast', '78s-dl.jpg', 122.99, 'Battery', 2),
('813460', 'SynPower Full Synthetic Motor Oil', 'Valvoline', '813460.jpg', 36.99, 'Engine Oil', 7),
('85484', '4 Way Flat Trailer Wiring Circuit Tester', 'Reese Towpower', '85484.jpg', 3.99, 'Circuit Tester', 1),
('86273', 'Conduct-Tite Electrical Multi Tester', 'Dorman', '86273.jpg', 19.99, 'Circuit Tester', 1),
('903-0136', 'Wiper Arm', 'Auto7', '903-0136.jpg', 45.99, 'Wiper Arm', 1),
('97048', 'Wiper Blade', 'PIAA', '97048.jpg', 25.99, 'Wiper Blade', 1),
('A3095C', 'Air Filter', 'ACDelco', 'a3095c.jpg', 39.99, 'Air Filter', 1),
('DL-19', 'Wiper Blade', 'Duralast', 'dl-19.jpg', 9.99, 'Wiper Blade', 1),
('E-1650', 'Air Filter', 'K&N', 'e-1650.jpg', 62.99, 'Air Filter', 1),
('GS235B', 'Gold Battery Cable', 'Duralast', 'gs235b.jpg', 13.99, 'Battery Cable', 1),
('HD-DLG', 'Gold Battery', 'Duralast', 'hd-dlg.jpg', 179.99, 'Battery', 5),
('PBJS32000', 'Emergency 24V Jump Starter', 'POWERALL', 'pbjs32000.jpg', 239.99, 'Battery Booster', 1),
('PSJ-1812', 'ProSeries Portable Battery', 'Schumacher', 'psj-1812.jpg', 149.99, 'Battery Booster', 1),
('SA10720', 'Air Filter', 'STP', 'sa10720.jpg', 24.99, 'Air Filter', 1);
...
--
ALTER TABLE `carinfo`
  ADD CONSTRAINT `carinfo_ibfk_1` FOREIGN KEY (`PartNo`) REFERENCES `part` (`PartNo`) ON UPDATE CASCADE;

--
-- Constraints for table `oinventory`
--
ALTER TABLE `oinventory`
  ADD CONSTRAINT `oinventory_ibfk_1` FOREIGN KEY (`OrderID`) REFERENCES `orders` (`OrderID`) ON UPDATE CASCADE,
  ADD CONSTRAINT `oinventory_ibfk_2` FOREIGN KEY (`PartNo`) REFERENCES `part` (`PartNo`) ON UPDATE CASCADE;

--
-- Constraints for table `orders`
--
ALTER TABLE `orders`
  ADD CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`Username`) REFERENCES `customer` (`Username`) ON UPDATE CASCADE,
  ADD CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`StoreID`) REFERENCES `store` (`StoreID`) ON UPDATE CASCADE;
...
--
ALTER TABLE `sinventory`
  ADD CONSTRAINT `sinventory_ibfk_1` FOREIGN KEY (`StoreID`) REFERENCES `store` (`StoreID`) ON UPDATE CASCADE,
  ADD CONSTRAINT `sinventory_ibfk_2` FOREIGN KEY (`PartNo`) REFERENCES `part` (`PartNo`) ON UPDATE CASCADE;
...
ALTER TABLE `supplies`
  ...
  ADD CONSTRAINT `supplies_ibfk_2` FOREIGN KEY (`PartNo`) REFERENCES `part` (`PartNo`) ON UPDATE CASCADE;

--
-- Constraints for table `usercart`
--
ALTER TABLE `usercart`
  ADD CONSTRAINT `usercart_ibfk_1` FOREIGN KEY (`PartNo`) REFERENCES `part` (`PartNo`) ON UPDATE CASCADE,
  ADD CONSTRAINT `usercart_ibfk_2` FOREIGN KEY (`Username`) REFERENCES `customer` (`Username`) ON UPDATE CASCADE;

--
-- Constraints for table `users`
--
ALTER TABLE `users`
  ADD CONSTRAINT `users_ibfk_1` FOREIGN KEY (`Username`) REFERENCES `customer` (`Username`) ON UPDATE CASCADE;
COMMIT;
